...
const corsOptions = {
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Requested-With', 'user-id', 'Accept', 'Origin', 'Cache-Control'],
...
// Prevent caching of dynamic content to avoid history-based access to protected pages
