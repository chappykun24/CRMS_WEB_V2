  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Syllabus Approval</h1>
        <div className="bg-white rounded-lg shadow-sm p-12 text-center">
          ...
          <p className="text-gray-500 text-base max-w-md mx-auto">
            The syllabus approval feature is currently under development and will be available in a future update.
          </p>
        </div>
      </div>
    </div>
