-- Performance optimization indexes for CRMS database (CORRECTED VERSION)
-- Run this script to add indexes that will significantly improve query performance
-- This version matches the actual database schema where department_id is in user_profiles table
...
-- Indexes for user_profiles table (where department_id is stored)
